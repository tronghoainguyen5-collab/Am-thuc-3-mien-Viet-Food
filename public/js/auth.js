...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (btnLogin) {
    usernameSpan.innerText = user.username;
    avatarImg.src = "public/image/avatar.png"; // đổi avatar nếu có
    if (btnRegister) btnRegister.style.display = "none";

    // Hiển thị nút nâng quyền admin nếu chưa phải admin
    if (user.role !== "admin" && upgradeAdmin) {
      upgradeAdmin.style.display = "flex";
    }
